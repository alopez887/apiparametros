// /actividades/actividadduracion/agregarActividadDuracion.js
 ...
 * }
 */
export async function agregarActividadDuracion(req, res) {
  const { id } = req.params;
  ...
  try {
    ...
    console.error('❌ agregarActividadDuracion:', err);
    return res.status(500).json({ error: 'Error al actualizar actividad por duración' });
  }
}

export default agregarActividadDuracion;
